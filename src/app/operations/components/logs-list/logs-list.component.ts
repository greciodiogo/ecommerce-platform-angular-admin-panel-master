...
import { OperationsActions } from '../../store/actions';
import { selectLogsList } from '../../store/selectors/logs.selectors';
...
export class LogsListComponent implements OnInit, AfterViewInit, OnDestroy {
  logs$ = this.store.select(selectLogsList);
