...
export * from './delivery-settings-api.service';
import { DeliverySettingsApiService } from './delivery-settings-api.service';
...
export * from './operation-logs-api.service';
...
export * from './search-tags-api.service';
import { SearchTagsApiService } from './search-tags-api.service';
...
export * from './splash-screens-api.service';
import { SplashScreensApiService } from './splash-screens-api.service';
export * from './users-api.service';
import { UsersApiService } from './users-api.service';
export * from './webhooks-api.service';
...
export const APIS = [AddressApiService, AnalyticsApiService, AttributeTypesApiService, AuthApiService, BannersApiService, CartsApiService, CategoriesApiService, CodesApiService, DefaultApiService, DeliveryMethodsApiService, DeliverySettingsApiService, FaqsApiService, FeedbackApiService, ImportExportApiService, NotificationsApiService, OperationLogsApiService, OrdersApiService, PagesApiService, PaymentMethodsApiService, ProductRatingsApiService, ProductsApiService, PromotionsApiService, ReturnsApiService, SearchTagsApiService, SettingsApiService, ShopkeepersalesApiService, ShopsApiService, SplashScreensApiService, UsersApiService, WebhooksApiService, WishlistsApiService];
