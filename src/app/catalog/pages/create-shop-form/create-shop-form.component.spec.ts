...
import { CreateShopFormComponent } from './create-shop-form.component';
...
describe('CreateShopFormComponent', () => {
  let component: CreateShopFormComponent;
  let fixture: ComponentFixture<CreateShopFormComponent>;
  let store: MockStore;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [CreateShopFormComponent],
      providers: [
        provideMockStore({
          selectors: [
            {
    ...
    fixture = TestBed.createComponent(CreateShopFormComponent);
